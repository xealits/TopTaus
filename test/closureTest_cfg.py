...
#   baseMCDir        = cms.string("/lustre/data3/cmslocal/vischia/tau_dilepton/outputFiles444_3_nobtaggingForClosureTest/nomtcut/nomt-2011-V1-mc-MU-20GeV/"),
#   baseDataDir      = cms.string("/lustre/data3/cmslocal/vischia/tau_dilepton/outputFiles444_3_nobtaggingForClosureTest/nomtcut/nomt-2011-V1-data-MU-20GeV/"),
...
#    baseDataDir      = cms.string("/lustre/data3/cmslocal/vischia/tau_dilepton/outputFiles444_3_bakNew/nomtcut/nomt-2011-V1-data-MU-20GeV/"),
    ...
    mcBkgFileName      = cms.vstring(    "out-wjets.root", "out-ttbar_ddbkg.root", "out-wjets.root", "out-wjets.root"),
    ...
    mcBkgSampleName      = cms.vstring( "wjets", "fff", "ffff", "ffffff", "Z_eemumu3",  "Z_tautau3" ),
    ...
    mcBkgFancySampleName      = cms.vstring( "WJets", "fff", "ffff", "ffffff", "Z #rightarrow ee,#mu#mu" , "Z #rightarrow #tau#tau" ),
...
# for fig 7 #    mcBkgSampleColor    = cms.vint32( 614, 8, 824, 809,  596, 831, 831, 835 ),
    mcBkgSampleColor    = cms.vint32( 614, 8, 824),
