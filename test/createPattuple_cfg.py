...
# PRESELECTION #
################
from LIP.TopTaus.PreselectionSequences_cff import addPreselectionSequences
from LIP.TopTaus.PreselectionSequences_cff import addLumifilter
if(not runOnMC ):
...
START FROM HERE
addTriggerSequence(process,DAFUCK)
