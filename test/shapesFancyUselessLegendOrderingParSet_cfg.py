...
#    outFolder        = cms.string("shapesForDatacard_dphi/"),
    outFolder        = cms.string("shapesForDatacard_rc_tFigCorrection_2/"),
...
#                          ),
    ...
    fancySampleName      = cms.vstring("data", "H^{+}[m_{H^{#pm}} = 120 GeV]", "H^{+}[m_{H^{#pm}} = 120 GeV]", "misidentified #tau_{h}", "t#bar{t} #rightarrow #mu#tau_{h}", "other t#bar{t}", "Single t", "Diboson","DY + jets", "Z #rightarrow ee,#mu#mu"),

                                       #"Z #rightarrow #tau#tau", "Z #rightarrow ee,#mu#mu"),
