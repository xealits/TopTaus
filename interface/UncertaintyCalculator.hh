...
/**                                                                                                                                                                              
  ...
  \version  $Id: UncertaintyCalculator.hh,v 1.1 2013/02/01 19:34:48 vischia Exp $                                                                                                       
*/
...
public:
  ...
  PhysicsObject smearedJet(const PhysicsObject &origJet, double genJetPt, int mode); // Perhaps it would be better to create a class or a namespace METUtils
