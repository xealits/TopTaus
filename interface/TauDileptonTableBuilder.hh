...
namespace tableutils{
  ...
  public :
    ...
    void summaryTable( bool detailed, bool higgs,bool systset1, bool systset2, bool systset3, bool withShapes, bool withStatShapes, bool doTheDatacards);
    
    void doDatacards(vector<double>, vector<vector<double> >, vector<vector<double> >, vector<double>, bool, bool, string);
