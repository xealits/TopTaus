...
namespace tableutils{
  ...
  void TauDileptonTableBuilder::mcTable( int detailed, bool includeSoverB , bool printAllErrors, bool higgs, TString key, TString name,
					 bool systset1, bool systset2, bool systset3, bool systset4, bool systset5){ 
...
//   TString pFile(outputArea_+TString("nomt-BTAG-V1-mc-EL-20GeV/3hitHIGNewSFuncertns70300p02XfxxTauEf/out-ttFullLept-etau.root"));    TFile * processedFile     = TFile::Open(pFile); 
//   TString dFile(outputArea_+TString("nomt-NEWJ-V1-data-EL-20GeV/3hitHIGwplusjetp02Final/out-data.root"));   TFile * processedDataFile = TFile::Open(dFile); 
TString pFile(outputArea_+TString("nomt-BTAG-V1-mc-MU-20GeV/3hit0p2R0p4uncertnsNEWmudz0eta2p3TauEf/out-ttFullLept-mutau.root"));   TFile * processedFile     = TFile::Open(pFile); 
TString dFile(outputArea_+TString("nomt-NEWJ-V1-data-MU-20GeV/3hit0p2R0p4wplusjetTaueta2p3/out-data.root"));   TFile * processedDataFile = TFile::Open(dFile); 
  ...
  TString hName_topptplus;     hName_topptplus  = key+TString("/YieldsMC")+TString("/cutflow_yields_mc_topptplus_")  + leptauStringMC; 
  TString hName_topptminus;    hName_topptminus = key+TString("/YieldsMC")+TString("/cutflow_yields_mc_topptminus_") + leptauStringMC;
  ...
  TString hName_higgs_e_tau_topptplus;   hName_higgs_e_tau_topptplus  = key+TString("/Yields") + TString("/e_tau/cutflow_yields_topptplus_")  + etauString; 
  TString hName_higgs_e_tau_topptminus;  hName_higgs_e_tau_topptminus = key+TString("/Yields") + TString("/e_tau/cutflow_yields_topptminus_") + etauString;
  ...
  TString hName_higgs_m_tau_topptplus;   hName_higgs_m_tau_topptplus  = key+TString("/Yields") + TString("/m_tau/cutflow_yields_topptplus_")  + mtauString;  
  TString hName_higgs_m_tau_topptminus;  hName_higgs_m_tau_topptminus = key+TString("/Yields") + TString("/m_tau/cutflow_yields_topptminus_") + mtauString;
  ...
  TH2D * h_uncplus(0); TH2D * h_uncminus(0); TH2D * h_jerplus(0); TH2D * h_jerminus(0); TH2D * h_tesplus(0); TH2D * h_tesminus(0);
  TH2D * h_topptplus(0); TH2D * h_topptminus(0); TH2D * h_bplus(0); TH2D * h_bminus(0);TH2D * h_trigger(0);
  ...
  vector< TH1D * > h_hh_e, h_hh_e_plus, h_hh_e_minus, h_hh_e_uncplus, h_hh_e_uncminus, h_hh_e_jerplus, h_hh_e_jerminus,
    h_hh_e_tesplus, h_hh_e_tesminus, h_hh_e_topptplus, h_hh_e_topptminus, h_hh_e_bplus, h_hh_e_bminus, h_hh_e_trigger;
  vector< TH1D * > h_hh_m, h_hh_m_plus, h_hh_m_minus, h_hh_m_uncplus, h_hh_m_uncminus, h_hh_m_jerplus, h_hh_m_jerminus,
    h_hh_m_tesplus, h_hh_m_tesminus, h_hh_m_topptplus, h_hh_m_topptminus, h_hh_m_bplus, h_hh_m_bminus, h_hh_m_trigger;
    
  vector< TH1D * > h_hw_e, h_hw_e_plus, h_hw_e_minus, h_hw_e_uncplus, h_hw_e_uncminus, h_hw_e_jerplus, h_hw_e_jerminus,
    h_hw_e_tesplus, h_hw_e_tesminus, h_hw_e_topptplus, h_hw_e_topptminus, h_hw_e_bplus, h_hw_e_bminus, h_hw_e_trigger; 
  vector< TH1D * > h_hw_m, h_hw_m_plus, h_hw_m_minus, h_hw_m_uncplus, h_hw_m_uncminus, h_hw_m_jerplus, h_hw_m_jerminus,
    h_hw_m_tesplus, h_hw_m_tesminus, h_hw_m_topptplus, h_hw_m_topptminus, h_hw_m_bplus, h_hw_m_bminus, h_hw_m_trigger;
  ...
  if(processedFile){ 
    ...
    h_topptplus  = (TH2D*) processedFile->Get(hName_topptplus);
    h_topptminus = (TH2D*) processedFile->Get(hName_topptminus);
  ...
  for(uint i = 0; i< hhFiles.size(); i++ ){ 
    ...
    if(processedHHFiles[i]){ 
      ...
      h_hh_e_topptplus.push_back( (TH1D *)(processedHHFiles[i])->Get(hName_higgs_e_tau_topptplus) ); h_hh_m_topptplus.push_back( (TH1D *)(processedHHFiles[i])->Get(hName_higgs_m_tau_topptplus) );   
      h_hh_e_topptminus.push_back((TH1D *)(processedHHFiles[i])->Get(hName_higgs_e_tau_topptminus)); h_hh_m_topptminus.push_back((TH1D *)(processedHHFiles[i])->Get(hName_higgs_m_tau_topptminus));  
      ...
      h_hh_e_uncplus.push_back(0); h_hh_e_uncminus.push_back(0); h_hh_e_jerplus.push_back(0); h_hh_e_jerminus.push_back(0); h_hh_e_tesplus.push_back(0); h_hh_e_tesminus.push_back(0);
      h_hh_e_topptplus.push_back(0); h_hh_e_topptminus.push_back(0); h_hh_e_bplus.push_back(0);   h_hh_e_bminus.push_back(0);

      h_hh_m.push_back(0);  h_hh_m_plus.push_back(0); h_hh_m_minus.push_back(0); h_hh_m_trigger.push_back(0);
      h_hh_m_uncplus.push_back(0); h_hh_m_uncminus.push_back(0); h_hh_m_jerplus.push_back(0); h_hh_m_jerminus.push_back(0); h_hh_m_tesplus.push_back(0); h_hh_m_tesminus.push_back(0);
      h_hh_m_topptplus.push_back(0); h_hh_m_topptminus.push_back(0); h_hh_m_bplus.push_back(0); h_hh_m_bminus.push_back(0); 
  ...
  for(uint i = 0; i< hwFiles.size(); i++ ){ 
    ...
    if(processedHWFiles[i]){ 
      ...
      h_hw_e_topptplus.push_back( (TH1D *)(processedHWFiles[i])->Get(hName_higgs_e_tau_topptplus) ); h_hw_m_topptplus.push_back( (TH1D *)(processedHWFiles[i])->Get(hName_higgs_m_tau_topptplus) ); 
      h_hw_e_topptminus.push_back((TH1D *)(processedHWFiles[i])->Get(hName_higgs_e_tau_topptminus)); h_hw_m_topptminus.push_back((TH1D *)(processedHWFiles[i])->Get(hName_higgs_m_tau_topptminus)); 
      ...
      h_hw_e_uncplus.push_back(0); h_hw_e_uncminus.push_back(0); h_hw_e_jerplus.push_back(0); h_hw_e_jerminus.push_back(0); h_hw_e_tesplus.push_back(0); h_hw_e_tesminus.push_back(0);
      h_hw_e_bplus.push_back(0); h_hw_e_bminus.push_back(0); h_hw_e_topptplus.push_back(0); h_hw_e_topptminus.push_back(0);

      h_hw_m.push_back(0); h_hw_m_plus.push_back(0); h_hw_m_minus.push_back(0); h_hw_m_trigger.push_back(0);
      h_hw_m_uncplus.push_back(0); h_hw_m_uncminus.push_back(0); h_hw_m_jerplus.push_back(0); h_hw_m_jerminus.push_back(0); h_hw_m_tesplus.push_back(0); h_hw_m_tesminus.push_back(0);
      h_hw_m_bplus.push_back(0); h_hw_m_bminus.push_back(0); h_hw_m_topptplus.push_back(0); h_hw_m_topptminus.push_back(0);
...
//          systErrPlus[14][16],  systErrMinus[14][16];
  ...
  // copy all data to matrix ( x = 14 steps of selection ,y =18 = 15 ev types + 1 total + 2 for S/B and S/sqrt B )
  double d[14][18], e[14][18], d_plus[14][18], d_minus[14][18], 
         ...
         d_topptplus[14][18],   d_topptminus[14][18], 
         d_trigger[14][18],
  ...
  for(uint samp=0; samp<h_hh_e.size(); samp++){
    ...
    for(int x=0; x<14;x++){
      ...
      double data_hh_e_topptplus, data_hh_e_topptminus, data_hh_m_topptplus, data_hh_m_topptminus;
      ...
      if( h_hh_e_topptplus[samp]  !=0 ){ data_hh_e_topptplus  = h_hh_e_topptplus[samp]->GetBinContent(x+1);   } else { data_hh_e_topptplus = 0 ;       }
      if( h_hh_e_topptminus[samp] !=0 ){ data_hh_e_topptminus = h_hh_e_topptminus[samp]->GetBinContent(x+1) ; } else { data_hh_e_topptminus= 0 ;       } 
      if( h_hh_m_topptplus[samp]  !=0 ){ data_hh_m_topptplus  = h_hh_m_topptplus[samp]->GetBinContent(x+1);   } else { data_hh_m_topptplus = 0 ;       }
      if( h_hh_m_topptminus[samp] !=0 ){ data_hh_m_topptminus = h_hh_m_topptminus[samp]->GetBinContent(x+1);  } else { data_hh_m_topptminus= 0 ;       }
     ...
     if( h_hh_e_bplus[samp]    !=0 ){ data_hh_e_bplus    = h_hh_e_bplus[samp]->GetBinContent(x+1);     } else { data_hh_e_bplus = 0 ;         }
      ...
      double syst_topptplus_e  = fabs( data_hh_e[x]-data_hh_e_topptplus  );  double syst_topptplus_m  = fabs( data_hh_m[x]-data_hh_m_topptplus );
      double syst_topptminus_e = fabs( data_hh_e[x]-data_hh_e_topptminus );  double syst_topptminus_m = fabs( data_hh_m[x]-data_hh_m_topptminus );
      ...
      if(systset1){ 
        ...
        syst_topptplus_e = 0; syst_topptplus_m=0;  syst_topptminus_e = 0; syst_topptminus_m=0; syst_trigger_e = 0;  syst_trigger_m=0;
      }
      if(systset2){
        syst_tauid_e =0;  syst_tauid_m=0; syst_lum_e =0; syst_lum_m=0; syst_eff_e=0; syst_eff_m=0; syst_ttbar_cs_e=0; syst_ttbar_cs_m=0; 
        syst_plus_e = 0;  syst_plus_m=0;  syst_minus_e = 0; syst_minus_m=0; syst_tesplus_e = 0; syst_tesplus_m=0;  syst_tesminus_e = 0; syst_tesminus_m=0;
        ...
        syst_trigger_e = 0;  syst_trigger_m=0; syst_topptplus_e = 0; syst_topptplus_m=0;  syst_topptminus_e = 0; syst_topptminus_m=0;            
      }
      if(systset3){
        syst_tauid_e =0;  syst_tauid_m=0; syst_lum_e =0; syst_lum_m=0; syst_eff_e=0; syst_eff_m=0; syst_ttbar_cs_e=0; syst_ttbar_cs_m=0; 
        syst_bplus_e = 0; syst_bplus_m=0; syst_bminus_e = 0; syst_bminus_m=0; syst_tesplus_e = 0; syst_tesplus_m=0;  syst_tesminus_e = 0; syst_tesminus_m=0;  
        syst_plus_e = 0;  syst_plus_m=0;  syst_minus_e  = 0; syst_minus_m =0; syst_topptplus_e = 0; syst_topptplus_m=0;  syst_topptminus_e = 0; syst_topptminus_m=0;
        syst_uncplus_e = 0;  syst_uncplus_m=0;  syst_uncminus_e = 0; syst_uncminus_m=0;
        syst_jerplus_e = 0;  syst_jerplus_m=0;  syst_jerminus_e = 0; syst_jerminus_m=0;               
      }
      if(systset4){
        syst_tauid_e =0;  syst_tauid_m=0; syst_lum_e =0; syst_lum_m=0; syst_eff_e=0; syst_eff_m=0; syst_ttbar_cs_e=0; syst_ttbar_cs_m=0; 
        syst_plus_e = 0;  syst_plus_m=0;  syst_minus_e = 0; syst_minus_m=0; syst_bplus_e = 0; syst_bplus_m=0; syst_bminus_e = 0; syst_bminus_m=0;
        syst_uncplus_e = 0;  syst_uncplus_m=0;  syst_uncminus_e = 0; syst_uncminus_m=0;
        syst_jerplus_e = 0;  syst_jerplus_m=0;  syst_jerminus_e = 0; syst_jerminus_m=0;   
        syst_trigger_e = 0;  syst_trigger_m=0;  syst_topptplus_e = 0; syst_topptplus_m=0;  syst_topptminus_e = 0; syst_topptminus_m=0;                
      }
      if(systset5){
        ...
        syst_uncplus_e = 0;  syst_uncplus_m=0;  syst_uncminus_e = 0; syst_uncminus_m=0;
        syst_jerplus_e = 0;  syst_jerplus_m=0;  syst_jerminus_e = 0; syst_jerminus_m=0;   
        syst_trigger_e = 0;  syst_trigger_m=0;  syst_tesplus_e = 0; syst_tesplus_m=0;  syst_tesminus_e = 0; syst_tesminus_m=0;                
      }
      ...
      data_syst_e_plus.push_back(  sqrt( pow(syst_plus_e,2)   + pow(syst_uncplus_e,2)  + pow(syst_jerplus_e,2)  + pow(syst_bplus_e,2) + pow(syst_tesplus_e,2) + pow(syst_topptplus_e,2) + temp_e )); 
      data_syst_e_minus.push_back( sqrt( pow(syst_minus_e,2)  + pow(syst_uncminus_e,2) + pow(syst_jerminus_e,2) + pow(syst_bminus_e,2) + pow(syst_tesminus_e,2) + pow(syst_topptminus_e,2) + temp_e )); 
      data_syst_m_plus.push_back(  sqrt( pow(syst_plus_m,2)   + pow(syst_uncplus_m,2)  + pow(syst_jerplus_m,2)  + pow(syst_bplus_m,2) + pow(syst_tesplus_m,2) + pow(syst_topptplus_m,2) + temp_m )); 
      data_syst_m_minus.push_back( sqrt( pow(syst_minus_m,2)  + pow(syst_uncminus_m,2) + pow(syst_jerminus_m,2) + pow(syst_bminus_m,2) + pow(syst_tesminus_m,2) + pow(syst_topptminus_m,2) + temp_m ));
  ...
  for(uint samp=0; samp<h_hw_e.size(); samp++){
    ...
    for(int x=0; x<14;x++){
      ...
      double data_hw_e_topptplus, data_hw_e_topptminus, data_hw_m_topptplus, data_hw_m_topptminus;
      ...
      if( h_hw_e_topptplus[samp]  !=0 ){ data_hw_e_topptplus  = h_hw_e_topptplus[samp]->GetBinContent(x+1); } else { data_hw_e_topptplus = 0 ;      }
      if( h_hw_e_topptminus[samp] !=0 ){ data_hw_e_topptminus = h_hw_e_topptminus[samp]->GetBinContent(x+1);} else { data_hw_e_topptminus= 0 ;      } 
      if( h_hw_m_topptplus[samp]  !=0 ){ data_hw_m_topptplus  = h_hw_m_topptplus[samp]->GetBinContent(x+1); } else { data_hw_m_topptplus = 0 ;      }
      if( h_hw_m_topptminus[samp] !=0 ){ data_hw_m_topptminus = h_hw_m_topptminus[samp]->GetBinContent(x+1);} else { data_hw_m_topptminus= 0 ;      }
      ...
      double syst_topptplus_e  = fabs( data_hw_e[x]-data_hw_e_topptplus );  double syst_topptplus_m  = fabs( data_hw_m[x]-data_hw_m_topptplus );
      double syst_topptminus_e = fabs( data_hw_e[x]-data_hw_e_topptminus ); double syst_topptminus_m = fabs( data_hw_m[x]-data_hw_m_topptminus );
...
//       data_syst_m_minus.push_back( sqrt( pow(syst_minus_m,2)  + pow(syst_uncminus_m,2) + pow(syst_jerminus_m,2) + pow(syst_bminus_m,2) + pow(syst_tesminus_m,2)  + temp_m ));
  ...
  for(int x=0;x<14;x++){ 
    ...
    for(int y=0;y<17;y++){ 
      d[x][y]=0; e[x][y]=0; d_trigger[x][y]=0; d_plus[x][y]=0; d_minus[x][y]=0; d_topptplus[x][y]=0; d_topptminus[x][y]=0;
  ...
  for(int x=0;x<14;x++){
    ...
    for(int y=0;y<15;y++){  
      ...
      if(h_topptplus)  { d_topptplus[x][y]  = ( h_topptplus->GetBinContent(x+1,y+1) ) ;                                                    } 
      if(h_topptminus) { d_topptminus[x][y] = ( h_topptminus->GetBinContent(x+1,y+1)) ;                                                    }
...
//         double scalefactor( XSEC_EXP_ / 165. );  //note it should be 165
      if( XSECMEASUREMENT && ( y==ETAU_TDCH || y==MUTAU_TDCH || y==LEPJETS_TDCH || y==EE_TDCH || y==EMU_TDCH || y==MUMU_TDCH //y==LEPLEP_TDCH
			       || y==TAUJETS_TDCH || y==TAUTAU_TDCH || y==ALLJETS_TDCH)  ){  
	//        double scalefactor( XSEC_EXP_ / 245.8 * 3.658757 /*4.448875*/ / 3.8877952 /*4.72748768*/ );
        double scalefactor( 251.7/251.7 );
        d[x][y]          *= scalefactor ; 
	...
	d_topptplus[x][y]  *= scalefactor * 3.8877952 /*4.72748768*/ / 4.139345594 /*5.0334557*/;
        d_topptminus[x][y] *= scalefactor / 3.658757 /*4.448875*/ * 3.8877952 /*4.72748768*/ ;
      ...
      double syst_topptplus  = fabs(d[x][y]-d_topptplus[x][y]);    
      double syst_topptminus = fabs(d[x][y]-d_topptminus[x][y]); 
...
//       else if( y==ETAU_TDCH || y==MUTAU_TDCH || y==LEPJETS_TDCH || y==LEPLEP_TDCH || y==TAUJETS_TDCH || y==TAUTAU_TDCH || y==ALLJETS_TDCH ){ sample_cs = TTBAR_CS_ERR;     }
      else if( y==ETAU_TDCH || y==MUTAU_TDCH || y==LEPJETS_TDCH || y==EE_TDCH || y==EMU_TDCH || y==MUMU_TDCH //y==LEPLEP_TDCH
	       || y==TAUJETS_TDCH || y==TAUTAU_TDCH || y==ALLJETS_TDCH ){ sample_cs = TTBAR_CS_ERR;     }
...
//       else if( x >= TAUSTEP && ( y==LEPJETS_TDCH || y==ZJETS_TDCH || y==LEPLEP_TDCH )  ){ syst_tauid = TAU_MISSID_ERR*d[x][y]; }
      if     ( x >= TAUSTEP && y!=LEPJETS_TDCH && y!=ZJETS_TDCH  && y!=EE_TDCH && y!=EMU_TDCH && y!= MUMU_TDCH    ){ syst_tauid = TAU_ID_ERR*d[x][y];   }    //LEPLEP_TDCH     ){ syst_tauid = TAU_ID_ERR*d[x][y];     }  
      else if( x >= TAUSTEP && ( y==LEPJETS_TDCH || y==ZJETS_TDCH || y==EE_TDCH || y==EMU_TDCH || y==MUMU_TDCH  )  ){ syst_tauid = TAU_MISSID_ERR*d[x][y]; }    //LEPLEP_TDCH )  ){ syst_tauid = TAU_MISSID_ERR*d[x][y]; }
	...
	syst_topptplus = 0;  syst_topptminus = 0;
      }
      if(systset2){
        syst_tauid = 0;  syst_lum = 0; syst_eff_lep=0; syst_cs=0; ; 
	...
	syst_topptplus = 0;  syst_topptminus = 0;
      ...
      if(systset4){
        syst_tauid = 0;  syst_lum = 0; syst_eff_lep=0; syst_cs=0; ; 
        syst_uncplus = 0; syst_uncminus= 0;  syst_jerplus = 0;  syst_jerminus = 0; syst_plus=0; syst_minus=0; syst_theoryeff=0;
        syst_trigger=0; syst_bplus = 0;  syst_bminus = 0;
	syst_topptplus = 0;  syst_topptminus = 0;
      }
      if(systset5){
        syst_tauid = 0;  syst_lum = 0; syst_eff_lep=0; syst_cs=0; ; 
	...
	syst_tesplus = 0;  syst_tesminus = 0;
      ...
      systErrPlus[x][y]  = sqrt( pow(syst_plus,2)  + pow(syst_uncplus,2)  + pow(syst_jerplus,2)  + pow(syst_bplus,2)  + pow(syst_tesplus,2)  + pow(syst_topptplus,2)  + temp ); 
      systErrMinus[x][y] = sqrt( pow(syst_minus,2) + pow(syst_uncminus,2) + pow(syst_jerminus,2) + pow(syst_bminus,2) + pow(syst_tesminus,2) + pow(syst_topptminus,2) + temp );
    ...
    double signal_topptplus(d_topptplus[x][0] + d_topptplus[x][1]), signal_topptminus( d_topptminus[x][0] + d_topptminus[x][1]);
    ...
    double bkg(0),bkg_plus(0), bkg_minus(0), bkg_uncplus(0), bkg_uncminus(0), bkg_jerplus(0), bkg_jerminus(0), bkg_tesplus(0), bkg_tesminus(0),
      bkg_topptplus(0), bkg_topptminus(0), bkg_bplus(0), bkg_bminus(0), err_bkg2(0), bkg_trigger(0); 
    for(int y2=2;y2<15;y2++){ 
      ...
      bkg_topptminus += d_topptminus[x][y2]; bkg_topptplus += d_topptplus[x][y2];
    ...
    d_bplus[x][15]   = signal_bplus + bkg_bplus; d_tesplus[x][15]  = signal_tesplus  + bkg_tesplus;  d_topptplus[x][15]  = signal_topptplus  + bkg_topptplus; 
    ...
    d_bminus[x][15]  = signal_bminus  + bkg_bminus; d_tesminus[x][15] = signal_tesminus + bkg_tesminus; d_topptminus[x][15] = signal_topptminus + bkg_topptminus;
    ...
    double temp_syst_topptplus   = fabs(d_topptplus[x][15] - d[x][15]);   
    double temp_syst_topptminus  = fabs(d_topptminus[x][15]- d[x][15]);
    ...
    double temp_syst_ttbar      = TTBAR_CS_ERR     * ( d[x][ETAU_TDCH]+d[x][MUTAU_TDCH]+d[x][LEPJETS_TDCH]+d[x][EE_TDCH]+d[x][EMU_TDCH]+d[x][MUMU_TDCH]
						       +d[x][TAUJETS_TDCH]+d[x][TAUTAU_TDCH]+d[x][ALLJETS_TDCH]);
    ...
    double temp_syst_misstauid  = 0; if( x>=TAUSTEP ){ temp_syst_misstauid = TAU_MISSID_ERR *(d[x][LEPJETS_TDCH]+d[x][EE_TDCH]+d[x][EMU_TDCH]+d[x][MUMU_TDCH]+d[x][ALLJETS_TDCH]);              }
    ...
    if(systset1){ 
      ...
      temp_syst_bplus =0; temp_syst_bminus = 0;  temp_syst_tesplus = 0; temp_syst_tesminus = 0; temp_syst_topptplus = 0; temp_syst_topptminus = 0;
      syst_theoryeff=0;
      temp_syst_trigger=0;
    }
    if(systset2){
      ...
      temp_syst_eff_lep   = 0;
      temp_syst_tauid =0; temp_syst_qcd=0; temp_syst_ttbar =0; temp_syst_wjets=0; temp_syst_singletop=0; temp_syst_diboson=0; temp_syst_zjets=0; temp_syst_lum=0;
      temp_syst_plus = 0; temp_syst_minus = 0; temp_syst_tesplus = 0; temp_syst_tesminus = 0; temp_syst_topptplus = 0; temp_syst_topptminus = 0;
   ...
   if(systset3){    
    ...
    if(systset4){
      ...
      temp_syst_eff_lep   = 0;
      temp_syst_tauid =0; temp_syst_qcd=0; temp_syst_ttbar =0; temp_syst_wjets=0; temp_syst_singletop=0; temp_syst_diboson=0; temp_syst_zjets=0; temp_syst_lum=0;
      temp_syst_plus = 0; temp_syst_minus = 0; temp_syst_bplus = 0; temp_syst_bminus = 0; temp_syst_topptplus = 0; temp_syst_topptminus = 0; 
      temp_syst_uncplus = 0; temp_syst_uncminus = 0;
      temp_syst_jerplus = 0; temp_syst_jerminus = 0;
      syst_theoryeff=0;
      temp_syst_trigger=0;
    ...
    if(systset5){
      ...
      temp_syst_eff_lep   = 0;
      temp_syst_tauid =0; temp_syst_qcd=0; temp_syst_ttbar =0; temp_syst_wjets=0; temp_syst_singletop=0; temp_syst_diboson=0; temp_syst_zjets=0; temp_syst_lum=0;
      temp_syst_plus = 0; temp_syst_minus = 0; temp_syst_bplus = 0; temp_syst_bminus = 0; temp_syst_tesplus = 0; temp_syst_tesminus = 0; 
      temp_syst_uncplus = 0; temp_syst_uncminus = 0;
      temp_syst_jerplus = 0; temp_syst_jerminus = 0;
      syst_theoryeff=0;
      temp_syst_trigger=0;
   ...
   syst_error_plus[x]  = sqrt( pow(temp_syst_plus,2)  + pow(temp_syst_uncplus,2) + pow(temp_syst_jerplus,2) + pow(temp_syst_tesplus,2)  + pow(temp_syst_topptplus,2) + pow(temp_syst_bplus,2) + temp );
   syst_error_minus[x] = sqrt( pow(temp_syst_minus,2) + pow(temp_syst_uncminus,2) + pow(temp_syst_jerminus,2) + pow(temp_syst_tesminus,2) + pow(temp_syst_topptminus,2) + pow(temp_syst_bminus,2) + temp );
  ...
  if(systset4)             systName=TString("-TAUSCALE");
  if(systset5)             systName=TString("-TOPPTUNC");
...
void TauDileptonTableBuilder::summaryTable( bool detailed, bool higgs, bool systset1, bool systset2, bool systset3){ 
  ...
  double ttbar_init(25610100); // evt processed from debug.txt
  //fn double ttbar_init(12011400); // evt in minitrees
  ...
  // FIXME: hardcoded
  //Muon  double lum(19258.2); double lumFactor(1); double scalefactor(1.); double scale(0.57221662); //0.51393073; //double scale(0.02184544); // NEW VALUES
  double lum(19696.); double lumFactor(1); double scalefactor(1.); double scale(0.19357532); //0.51393073; //double scale(0.02184544); // NEW VALUES        
  ...
  //fn  double tau_fakes(1679.77);     double tau_fakes_stat2( 0); double tau_fakes_syst2(144);    // MT > 40 GeV applied
  double tau_fakes(1235);     double tau_fakes_stat2(3*3); double tau_fakes_syst2(135*135);    // from likelihood fit in 4903/pb
  ...
  int TAU_NOMT, OS_NOMT;

  if (APPLY_MT_CUT_) { TAU_NOMT = TAU_STEP2; OS_NOMT = OS_STEP2; }
  else { TAU_NOMT = TAU_STEP2 - 1; OS_NOMT = OS_STEP2 - 1; }
  
  TAUSTEP = TAU_NOMT; BTAG1STEP = BTAG1_STEP2; /*STEP=BTAG1_STEP2; */ STEP = OS_NOMT;
// nomt //  if(     STARTINGPOINT == STARTING_AT_LJETS_         ){ COL2 = JET3_STEP2; COL3=MET_STEP2;    COL4=BTAG1_STEP2; COL5=TAU_NOMT; COL6=OS_NOMT;    COL7=BTAG2_STEP2; COL8=R_STEP1; }
// nomt //  else if( STARTINGPOINT == STARTING_AT_LJETSPLUSMET_ ){ COL2 = MET_STEP2;   COL3=BTAG1_STEP2 ;  COL4=TAU_NOMT;   COL5=OS_NOMT;  COL6=BTAG2_STEP2; COL7=R_STEP2; }                 

  if(     STARTINGPOINT == STARTING_AT_LJETS_         ){ COL2 = JET3_STEP2; COL3=MET_STEP2;   COL4=MT_STEP2;  COL5=BTAG1_STEP2; COL6=TAU_NOMT; COL7=OS_NOMT;    COL8=BTAG2_STEP2; COL9=R_STEP1; }
  else if( STARTINGPOINT == STARTING_AT_LJETSPLUSMET_ ){ COL2 = MET_STEP2;  COL3=MT_STEP2; COL4=BTAG1_STEP2 ;  COL5=TAU_NOMT;   COL6=OS_NOMT;  COL7=BTAG2_STEP2; COL8=R_STEP2; }                 
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  else if(addXsection){ fName=TString("accepEL-PowThia-")+keys[0]+ systName + vName +TString(".tex");}
  
  TFile * processedMCFile = TFile::Open(outputArea_+TString("nomt-BTAG-V1-mc-EL-20GeV/3hitHIGNewSFuncertns70300p02XfxxPowhe/out-ttPowThia-etau.root"));
  TFile * processedDataFile = TFile::Open(outputArea_+TString("nomt-NEWJ-V1-data-EL-20GeV/3hitHIGwplusjetp02/out-data.root"));
  //  TFile * processedMCFile = TFile::Open(outputArea_+TString("nomt-BTAG-V1-mc-MU-20GeV/3hit0p2R0p4uncertnsNEWmudz0eta2p3Powhe/out-ttPowRwig-mutau.root"));
  //  TFile * processedDataFile = TFile::Open(outputArea_+TString("nomt-NEWJ-V1-data-MU-20GeV/3hit0p2R0p4wplusjetTaueta2p3/out-data.root")); 
  ...
  for(uint j=0; j<keys.size(); j++){
	...
	//        if( XSECMEASUREMENT && y==LEPLEP_TDCH ){   
        if( XSECMEASUREMENT && ( y==EE_TDCH || y==EMU_TDCH || y==MUMU_TDCH ) ){   
          // Note : we re-scale ttbar lepton+lepton ( we get it from MC)
          double scalefactor( 251.7 / 251.7 ); //note it should be 234 @ 8 TeV //note it should be 165 @ 7 TeV
          dMC[k]          *= scalefactor;
        ...
        if(      y==QCD_TDCH )                                                                                                               { sample_cs = QCD_CS_ERR ;      }
	//        else if( y==ETAU_TDCH || y==MUTAU_TDCH || y==LEPJETS_TDCH || y==LEPLEP_TDCH || y==TAUJETS_TDCH || y==TAUTAU_TDCH || y==ALLJETS_TDCH ){ sample_cs = TTBAR_CS_ERR;     }
        else if( y==ETAU_TDCH || y==MUTAU_TDCH || y==LEPJETS_TDCH || y==EE_TDCH || y==EMU_TDCH || y==MUMU_TDCH || y==TAUJETS_TDCH || y==TAUTAU_TDCH || y==ALLJETS_TDCH ){ sample_cs = TTBAR_CS_ERR;     }
        else if( y == SINGLETOP_TDCH )                                                                                                       { sample_cs = SINGLETOP_CS_ERR; }              
        else if( y == WJETS_TDCH     )                                                                                                       { sample_cs = WJETS_CS_ERR;     }              
        else                                                                                                                                 { sample_cs = OTHER_CS_ERR;     }
	...
	//        if(XSECMEASUREMENT && y==LEPLEP_TDCH ){ sample_cs = XSEC_EXP_ERR_; }
        if(XSECMEASUREMENT && ( y==EE_TDCH || y==EMU_TDCH || y==MUMU_TDCH ) ){ sample_cs = XSEC_EXP_ERR_; }
...
//         else if( x >= TAUSTEP && ( y==LEPJETS_TDCH || y==ZJETS_TDCH || y==LEPLEP_TDCH )){ syst_tauid = TAU_MISSID_ERR*dMC[k]; }
	if     ( x >= TAUSTEP && y!=LEPJETS_TDCH && y!=ZJETS_TDCH  && y!=EE_TDCH && y!=EMU_TDCH && y!= MUMU_TDCH    ){ syst_tauid = TAU_ID_ERR*dMC[k];     }
	else if( x >= TAUSTEP && ( y==LEPJETS_TDCH || y==ZJETS_TDCH || y==EE_TDCH || y==EMU_TDCH || y==MUMU_TDCH  )  ){ syst_tauid = TAU_MISSID_ERR*dMC[k]; }
  ...
  {    
    ...
    // first algorithm /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    double signal_0= (dMC[e0]+dMC[mu0]); //*24.57/245.8; 
...
//  cout<<endl<<" Acceptance   : "<<acceptance<<" +- "<<acceptance_stat<<" +- "<<acceptance_syst<<endl;
  ...
  { 
    ...
    vector<int> codes; codes.push_back(EE_TDCH); codes.push_back(EMU_TDCH); codes.push_back(MUMU_TDCH); //codes.push_back(LEPLEP_TDCH);
...
//       if( y==ETAU_TDCH || y==MUTAU_TDCH || y==LEPJETS_TDCH || y==LEPLEP_TDCH || y==TAUJETS_TDCH || y==TAUTAU_TDCH || y==ALLJETS_TDCH ){ 
      if( y==ETAU_TDCH || y==MUTAU_TDCH || y==LEPJETS_TDCH || y==EE_TDCH || y==EMU_TDCH || y==MUMU_TDCH
	  || y==TAUJETS_TDCH || y==TAUTAU_TDCH || y==ALLJETS_TDCH ){ 
