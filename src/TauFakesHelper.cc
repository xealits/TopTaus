...
/**   
      ...
      \version  $Id: TauFakesHelper.cc,v 1.1 2013/03/21 10:55:36 vischia Exp $                                                                                                       
*/
...
FRMCQCDTree::FRMCQCDTree(double tauPtCut, TString inputArea, TString outputArea) :
  ObjectSelector(tauPtCut),
  inputArea_(inputArea),
  outputArea_(outputArea)
{
...
void FRMCQCDTree::processEvents(){
  ComputeFakeRate("PFlow", "TauFRMCPassing_pt20", true);
  ComputeFakeRate("PFlow", "TauFRMCFailing_pt20", false);
  
  //    ComputeFakeRate("PFlow", "TauFRMCPassing_pt20_30To170_BTag", true, true);
  //    ComputeFakeRate("PFlow", "TauFRMCFailing_pt20_30To170_BTag", false, true);
  //
  //    ComputeFakeRate("PFlow", "TauFRMCPassing_pt20_30To170", true);
  //    ComputeFakeRate("PFlow", "TauFRMCFailing_pt20_30To170", false);
  
  //gApplication->Terminate(0);
}

void FRMCQCDTree::ComputeFakeRate(TString myKey, TString histoFiles_, bool passing, bool isAntiBTag)
{
...
void FRDataQCDTree::processEvents(){
  ...
  ComputeFakeRate(inputArea_+TString("JetsForFakes.root"), "PFlow", outputArea_+TString("TauFRDataPassing_QCD_pt20"), true);
  ComputeFakeRate(inputArea_+TString("JetsForFakes.root"), "PFlow", outputArea_+TString("TauFRDataFailing_QCD_pt20"), false);
...
void FRDataQCDTree::ComputeFakeRate(TString url,  TString myKey, TString histoFiles_, bool passing, bool isAntiBTag)
{
  ...
  cout << nEntries << " events are available" << endl;
  int nToProcess = nEntries;
  if(nToProcess > 500000) nToProcess = 500000; // FIXME: set this limit in another way
...
// FRWJetsTree
FRWJetsTree::FRWJetsTree(double tauPtCut, TString inputArea, TString outputArea, TString puFileName) : ObjectSelector(tauPtCut),
										   inputArea_(inputArea),
										   outputArea_(outputArea),
										   puFileName_(puFileName)
{
    ...
    std::vector<float> MCPUDist, DataPUDist;
    float dataDist_2011A[50] = {0.00592951, 0.0255428, 0.0591468, 0.097016, 0.126287, 0.138848, 0.134117, 0.11691, 0.0937398, 0.0700927, 0.0493627, 0.0329741, 0.0209976, 0.0127917, 0.00747402, 0.00419649, 0.00226774, 0.00118102, 0.000593481, 0.000288109, 0.000135272, 6.14976e-05, 2.71017e-05, 1.15906e-05, 4.81577e-06};
    float mcwjets_Dist[50] = {0.112659, 0.0644154, 0.0693515, 0.0699761, 0.0697531, 0.068983, 0.0675851, 0.0658866, 0.0628449, 0.0584268, 0.0532014, 0.0474007, 0.0411442, 0.0344648, 0.0280742, 0.0224119, 0.0175838, 0.0132863, 0.00985606, 0.00718983, 0.00509464, 0.00352637, 0.00239476, 0.00160454, 0.00106847};
    ...
    TFile* mcwjetsFile = new TFile(inputArea+TString("/WJetsToLNuForFakes.root"));
    TH1 * mcPileupHisto = (TH1*) mcwjetsFile->Get("myEventSelector/Selection/pileup");
    int histoEntries(51);
    if( mcPileupHisto ){  for( int s=1; s < mcPileupHisto->GetNbinsX() && s<histoEntries; s++ ){ MCPUDist.push_back( mcPileupHisto->GetBinContent(s)); } }
...
void FRWJetsTree::processEvents(){

    ComputeFakeRate(inputArea_+"/MuonForFakes.root", "PFlow", outputArea_+"/TauFRDataPassing_WMu_pt20", true, true);
    ComputeFakeRate(inputArea_+"/MuonForFakes.root", "PFlow", outputArea_+"/TauFRDataFailing_WMu_pt20", false, true);
     
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/data/fakerate/Muon.root", "PFlow", "TauFRDataPassing_WMu_pt20", true, true);
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/data/fakerate/Muon.root", "PFlow", "TauFRDataFailing_WMu_pt20", false, true);
//    

/// test ///    ComputeFakeRate("/lustre/data3/cmslocal/vischia/tau_dilepton/fakerate2011/inputSamples/WJetsToLNu.root", "PFlow", "TauFRMCPassing_WMu_pt20", true, false);
/// test ///    ComputeFakeRate("/lustre/data3/cmslocal/vischia/tau_dilepton/fakerate2011/inputSamples/WJetsToLNu.root", "PFlow", "TauFRMCFailing_WMu_pt20", false, false);

//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/mc/fakerate/WJetsToLNu_fr.root", "PFlow", "TauFRMCPassing_WMu_pt20", true, false);
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/mc/fakerate/WJetsToLNu_fr.root", "PFlow", "TauFRMCFailing_WMu_pt20", false, false);
//    
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/data/fakerate/Muon.root", "PFlow", "TauFRDataPassing_WMu_pt20_BTag", true, true, true);
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/data/fakerate/Muon.root", "PFlow", "TauFRDataFailing_WMu_pt20_BTag", false, true, true);
//    
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/mc/fakerate/WJetsToLNu_fr.root", "PFlow", "TauFRMCPassing_WMu_pt20_BTag", true, false, true);
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/mc/fakerate/WJetsToLNu_fr.root", "PFlow", "TauFRMCFailing_WMu_pt20_BTag", false, false, true);
//    
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/mc/fakerate/Muon.root", "PFlowM", "TauFRDataPassing_WMu_pt20_MIso", true, true);
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/mc/fakerate/Muon.root", "PFlowM", "TauFRDataFailing_WMu_pt20_MIso", false, true);
//    
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/mc/fakerate/WJetsToLNu_fr.root", "PFlowM", "TauFRMCPassing_WMu_pt20_MIso", true, false);
//    ComputeFakeRate("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/mc/fakerate/WJetsToLNu_fr.root", "PFlowM", "TauFRMCFailing_WMu_pt20_MIso", false, false);
...
void FRWJetsTree::ComputeFakeRate(TString url,  TString myKey, TString histoFiles_, bool passing, bool isDATA, bool isAntiBTag)
{
  ...
  //for(int i=0; i<1000; ++i)
	...
	if(tausColl[iorigtau][17] == tauType){
      ...
      PhysicsObjectCollection mets   = evReader->GetPhysicsObjectsFrom(ev,event::MET,metAlgo);
      if(mets.size()==0) { cout << "No met available"<<endl; continue;}
      PhysicsObject met = mets[0];
      ////////////////////////////////////////////////////////////////////////////////
      ...
      ProcessCleaning(&j_init, &j_toRemove, &e_init, &emptyColl, jets, electrons, DRMIN_JET_E_ );
      ProcessCleaning(&j_init, &j_toRemove, &m_init, &emptyColl, jets, muons,     DRMIN_JET_M_ );
      ApplyCleaning(&j_init, &j_toRemove, &j_final);
      /////////////////////////////////////////////////////////////////////////////////////////
...
// MyFakesTrainer
MyFakesTrainer::MyFakesTrainer(TString inputArea, TString configArea, TString outputArea, TString type, TString infix) :
  inputArea_(inputArea),
  configArea_(configArea),
  outputArea_(outputArea),
  type_(type),
  infix_(infix)
{
  ...
  //	TFile *f1 = TFile::Open("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/fakerate-inputToMVA/TauFRDataPassing_WMu_pt20_PFlow.root");
  fPassing_ = new TFile(inputArea_+TString("/TauFR")+infix_+TString("Passing_")+type_+TString("_pt20_PFlow.root"));
  if(fPassing_==0) return ;
  if(fPassing_->IsZombie()) { fPassing_->Close(); return; }
  tPassing_ = (TTree *) fPassing_->Get("tree");
  
  //	TFile *f2 = TFile::Open("/lustre/lip.pt/data/cmslocal/vischia/tau_dilepton/minitrees/fakerate-inputToMVA/TauFRDataFailing_WMu_pt20_PFlow.root");
  fFailing_ = new TFile(inputArea_+TString("/TauFR")+infix_+TString("Failing_")+type_+TString("_pt20_PFlow.root"));
  if(fFailing_==0) return ;
  if(fFailing_->IsZombie()) { fFailing_->Close(); return; }
  tFailing_ = (TTree *) fFailing_->Get("tree");
  ...
  // Save calibration to .mva file
  MVAComputer::writeCalibration(outputArea_+TString("Trained_")+type_+infix_+TString("PFlow_pt20.mva"), calib);


  std::cout << outputArea_+TString("Trained_")+type_+infix_+TString("PFlow_pt20.mva") << " written" << std::endl;
...
FakesMonitor::FakesMonitor(TString inputArea, TString infix, TString calibrationFile, TString outputArea) :
  inputArea_(inputArea),
  infix_(infix),
  ...
  outputArea_(outputArea)
{
  ...
  //  TString inputFilePath = "train/WMuMC_pt20/";
  TString inputFileName = inputArea_+TString("/train_FakeRateMethod_output.root");
  TFile* file = TFile::Open(inputFileName);
  TString testTreeName = "TestTree";
  TTree* testTree = (TTree*)file->Get(testTreeName);
  Float_t JetPt, JetWidth, AbsJetEta, weight, KNN;
...
void FakesMonitor::AddFakeRate(TH1* hn, TH1* hd, TH1* hf){
  TH1D * n; TH1 *d;
  n = (TH1D*)hn->Clone();
  d = (TH1D*)hd->Clone();
...
double FakesMonitor::GetErrorFraction( double& a,double& b){
  double ret(0);
  if (b){
    double temp = fabs(a)/(b*b)+ fabs( (a*a)/(b*b*b)) ;
    ret = sqrt(temp);
...
void FakesMonitor::GetPlotsFRPt(TH1D* data, TH1D* mc, TString name, const char* xaxis_title, float ymin, float ymax, float xmin, float xmax)
{
  TCanvas* c1 = new TCanvas();
  //c1->SetLogy();
  //Pad positioning stuff
...
void FakesMonitor::GetPlotsFRAbsEta(TH1D* data, TH1D* mc, TString name, const char* xaxis_title, float ymin, float ymax, float xmin, float xmax)
{
  TCanvas* c1 = new TCanvas();
  //c1->SetLogy();
  //Pad positioning stuff
...
void FakesMonitor::GetPlotsFRR(TH1D* data, TH1D* mc, TString name,  const char* xaxis_title, float ymin, float ymax, float xmin, float xmax)
{
  TCanvas* c1 = new TCanvas();
  //c1->SetLogy();
  //Pad positioning stuff
...
// FakesComputer
FakesComputer::FakesComputer(TString inputArea, TString outputArea):
  inputArea_(inputArea),
  outputArea_(outputArea)
{
...
void FakesComputer::PrepareFiles(TString infix){
  infix_ = infix;
  using namespace PhysicsTools;
...
///////  TFile *outFile_ = TFile::Open( "histosDiJetQCDJetMC.root", "RECREATE" );
  ...
  TString inputFileName = inputArea_ + TString("/train_") + infix_ + TString("/train_FakeRateMethod_output.root");
  //  MVAComputer mva(inputArea_+TString("Trained_")+infix_+TString("PFlow_pt20.mva"));
  std::cout << "Opening input filename " << inputFileName << std::endl;
  TFile* f = TFile::Open(inputFileName);
  std::cout << "Writing to filename " << inputFileName << std::endl;
  TFile* outFile_ = TFile::Open(outputArea_+TString("histos")+infix_+TString(".root"), "RECREATE");
...
void FakesComputer::AddFakeRate(TH1* hn, TH1* hd, TH1* hf){
...
double FakesComputer::GetErrorFraction( double& a,double& b){
  double ret(0);
  if (b){
    double temp = fabs(a)/(b*b)+ fabs( (a*a)/(b*b*b)) ;
    ret = sqrt(temp);
...
void FakesComputer::ComputeTauFake(string type, double TauPt, int option)
{
  string kNNfileData_, kNNfileMC_; 
  string frFileNameData_, frFileNameMC_;
  string frHistoName_ = "ptJetFR";
  ...
  if(type == "DiJet"){
    //    kNNfileData_ = "./QCDDiJet/TrainedDiJetDataPFlow_pt20_v3_temp.mva";
    kNNfileData_ = "/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/fakerate/weights/Trained_QCDDataPFlow_pt20.mva";
    //kNNfileData_ = "CalibFiles/QCDData_N20_pt20,mva";
    //    kNNfileMC_ = "./QCDDiJet/TrainedDiJetMCPFlow_pt20_v3_temp.mva";
    kNNfileMC_ = "/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/fakerate/weights/Trained_QCDMCPFlow_pt20.mva";
    frFileNameData_ ="/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/fakerate/output/histosQCDData.root";
    frFileNameMC_   ="/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/fakerate/output/histosQCDMC.root";
    
  }
  if(type == "WMu"){


    kNNfileData_ = "/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/fakerate/weights/Trained_WMuDataPFlow_pt20_2.mva";
    kNNfileMC_ =   "/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/fakerate/weights/Trained_WMuMCPFlow_pt20_2.mva";
    frFileNameData_ ="/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/fakerate/output/histosWMuData.root";
    frFileNameMC_   ="/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/fakerate/output/histosWMuMC.root";
  }
  ...
  dataFolder = "/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/nomt-2012-V1-data-MU-20GeV/";
  mcFolder   = "/lustre/ncg.ingrid.pt/cmslocal/samples/CMSSW_5_3_7_patch4/chiggs/nomt-2012-V1-mc-MU-20GeV/";
  
  //dataFolder  = "/lustre/lip.pt/data/cmslocal/samples/CMSSW_4_2_8_patch4b/data/processed-muon-RunA11-oldTau/";
  //mcFolder    = "/lustre/lip.pt/data/cmslocal/samples/CMSSW_4_2_8_patch4b/mc/processed-muon-Summer11-oldTau/";
  //e-tau
  //dataFolder  = "/lustre/lip.pt/data/cmslocal/samples/CMSSW_4_2_X/data/processed-v2/v2-data-20GeV-noweights-eonly/";
  //mcFolder    = "/lustre/lip.pt/data/cmslocal/samples/CMSSW_4_2_X/mc/processed-v2/v2-mc-20GeV-noweights-eonly/";
...
void FakesComputer::TauFakeEstimate(TString filename_, TString jetObject_, PhysicsTools::MVAComputer *mva, TH1F* frHisto, double* sumFakes, double* sumFakesError)
{
  using namespace PhysicsTools;
